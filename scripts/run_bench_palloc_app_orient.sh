...
workload_define_files=(6_threads_workload_define.conf)
bench_name=bench_item_app.sh
result_dir="palloc_app"
#strategy=6
num_threads=2
period=100
...
do
    ...
    do
        ...
        cd ${ROOT_DIR}/scripts
        setsid ./${bench_name} ${result_dir} ${workload_define_file} ${mix} ${num_threads} ${period} ${sudoPW} &
